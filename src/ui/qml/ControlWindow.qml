    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                // Global blackout / brightness slider (affects only external output window)
                Label {
                    text: qsTr("Blackout")
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                // Left side: tabs and their content
                ColumnLayout {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                ...
                // Right side: embedded output preview, always visible
                Rectangle {
                    id: previewPanel
